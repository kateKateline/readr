<!-- Table Search Row -->
<tr class="bg-[#0d1117] border-b border-[#21262d] search-row no-print">
    @foreach($searchColumns as $index => $column)
        <td class="py-2 px-6">
            <input 
                ...
                class="w-full bg-[#161b22] border border-[#21262d] rounded-md px-3 py-1.5 text-sm text-gray-300 placeholder-gray-500 focus:outline-none focus:border-[#30363d] focus:ring-1 focus:ring-[#30363d] transition search-input"
