@if(isset($recommendedComics) && $recommendedComics->isNotEmpty())
    <div class="mb-6 bg-[#0d1117] p-4 rounded-lg border border-[#21262d]">
        <div class="flex items-center justify-between mb-3">
            <h2 class="text-lg font-semibold text-gray-200">
                Recommended For You
            </h2>
            <span class="text-xs text-gray-400">
                Random picks from our library
            </span>
        </div>

        <div class="grid grid-cols-7 gap-3">
            @foreach($recommendedComics->take(7) as $item)
